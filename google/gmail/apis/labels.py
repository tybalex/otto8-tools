...
def list_labels(service) -> list[dict]:
    try:
        ...
        raise HttpError(f"An error occurred listing labels: {e}")
...
def get_label(service, label_id) -> dict:
    try:
        ...
        raise HttpError(f"An error occurred getting label {label_id}: {e}")
    except Exception as e:
        raise Exception(
...
def create_label(
    ...
    try:
        ...
        raise HttpError(f"An error occurred creating label '{name}': {e}")
    except Exception as e:
        raise Exception(
...
def update_label(
    ...
    try:
        ...
        raise HttpError(f"An error occurred updating label {label_id}: {e}")
    except Exception as e:
        raise Exception(
...
def delete_label(service, label_id) -> str:
    try:
        ...
        raise HttpError(f"An error occurred deleting label {label_id}: {e}")
    except Exception as e:
        raise Exception(
