...
def message_to_dict(message: Message) -> Dict[str, Any]:
    ...
    result = {
        ...
        "received_date_time": message.received_date_time.isoformat() if message.received_date_time else None,
        "sent_date_time": message.sent_date_time.isoformat() if message.sent_date_time else None,
        "created_date_time": message.created_date_time.isoformat() if message.created_date_time else None,
        "last_modified_date_time": message.last_modified_date_time.isoformat() if message.last_modified_date_time else None,
    ...
    if message.body:
        result["body"] = {
            "content_type": str(message.body.content_type) if message.body.content_type else None,
    ...
    if message.unique_body:
        result["unique_body"] = {
            "content_type": str(message.unique_body.content_type) if message.unique_body.content_type else None,
    ...
    if message.flag:
        result["flag"] = {
            ...
            "start_date_time": message.flag.start_date_time.isoformat() if message.flag.start_date_time else None,
            "due_date_time": message.flag.due_date_time.isoformat() if message.flag.due_date_time else None,
            "completed_date_time": message.flag.completed_date_time.isoformat() if message.flag.completed_date_time else None
        }
